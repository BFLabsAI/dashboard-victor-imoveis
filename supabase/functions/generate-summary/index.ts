...
// Usar variável de ambiente OU fallback para o valor configurado
const DEFAULT_API_KEY = Deno.env.get('OPENROUTER_API_KEY') || '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';
